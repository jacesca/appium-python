...
Run
`$ pytest -v -s AppiumFramework/tests/LoginFormTest.py`

With Allure Reports
`$ pytest -v -s --alluredir AppiumFramework/reports/allurereports/  AppiumFramework/tests/LoginFormTest.py`   # noqa
...
from AppiumFramework.pages.LoginPage import LoginForm
